...
import fnmatch
from misc.constants import ATOM_TYPES
...
class DOS:
    ...
    def get_states(self):
        ...
        Returns: A list of DOS states extracted from the DOSCAR.lobster file
    ...
    def get_state(self, state):
        ...
        Args:
            state: The specific state requested.

        Returns: The DOS information of the requested state.
    ...
    def print_plot(self, states_string, e_range=[]):
        """
        Plots the DOS all states requested in states_string and safes the plot to eps file.
        ...
        for dos_state in states_string.split():
